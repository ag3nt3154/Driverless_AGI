...
You MUST call the `write_handoff` tool if ANY of the following are true:
- You have completed your task.
- You are asking the user a question (any question — even a clarifying one).
- You are waiting for the user's approval, feedback, or direction.
