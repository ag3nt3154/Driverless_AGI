...
- **`tools:` allowlist** (`config.yaml`): post-registration filtering strips unnamed tools except mandatory `write_handoff`; `adjust_emotion` survives only when explicitly named.
