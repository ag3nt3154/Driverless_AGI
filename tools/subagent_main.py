...
def _apply_worker_config(config: AgentConfig) -> AgentConfig:
    ...
    return replace(
        ...
        affect_drift_interval=w.affect_drift_interval,
        plan_mode=False,
        plan_file=None,
        worker_config=None,
...
def _apply_advanced_config(config: AgentConfig) -> AgentConfig:
    ...
    return replace(
        ...
        affect_drift_pull=a.affect_drift_pull,
        affect_drift_noise=a.affect_drift_noise,
        affect_emote_hysteresis=a.affect_emote_hysteresis,
        affect_drift_interval=a.affect_drift_interval,
        plan_mode=False,
        plan_file=None,
        worker_config=None,
        advanced_config=None,
